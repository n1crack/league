...
const classes = computed(() => {
    return props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-red-400 dark:border-red-600 text-sm font-medium leading-5 text-red-900 dark:text-red-100 focus:outline-none focus:border-red-700 transition duration-150 ease-in-out'
